...
grocery_list=[]
#Electronics Variables yesko kaam option dekhaune ho
...
appliances_list=[]
# Second line heading and text
name=Label(Heading,text="The Small Mart",font="arial 20 bold italic",bg="light pink",fg="blue").grid(row=0,column=1)
tagline=Label(Heading,text="Hamro Pasal Ramro Pasal!",font="magneto 16 italic",fg="gold",bg="black").grid(row=0,column=2,padx=280)
...
def GroceryCall():
    ...
    label_grocery_1=Label(lf_grocery1,image=grocery1_image,bd=0).grid(row=0,column=0)
    ...
    name_grocery1=Label(lf_grocery1,text="Kellogg's Corn Flakes Original",font="arial 9",bd=0).grid(row=1,column=0)
    name_grocery2=Label(lf_grocery2,text="Aashirwaad Superior Atta",font="arial 9",justify="center",bd=0).grid(row=1,column=0,padx=15)
    ...
    label_qty_grocery1=Label(lf_grocery1,text="Qty:",bd=0,font="arial 9",justify="left").place(x=5,y=218)
...
def AppliancesCall():
 ...
 # Button OF every Groove   
Grocery_button=Button(Button_frame,text="Apple",font="times 20 bold",width=17,bd=6,bg="cadetblue",fg="white",activebackground="light blue",command=GroceryCall)
...
bill_gen_button=Button(root,bd=4,text="Proceed to Checkout",font="times 17 bold",bg="skyblue",fg="white",activebackground="purple",command=Bill)
bill_gen_button.place(x=40,y=690)
root.mainloop()